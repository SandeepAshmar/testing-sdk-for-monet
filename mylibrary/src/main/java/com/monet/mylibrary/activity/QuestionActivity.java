...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static ArrayList<SdkQuestions> preQuestions = new ArrayList<>();
    public static ArrayList<SdkQuestions> postQuestions = new ArrayList<>();
...
//                selectedQuesId = preQuestions.get(questionNo).getQuestion_id();
//                if (flagAdapter) {
//                    Toast.makeText(this, "type 6", Toast.LENGTH_SHORT).show();
////                    createGridAdapter();
//                    flagAdapter = false;
//                }
//            }
