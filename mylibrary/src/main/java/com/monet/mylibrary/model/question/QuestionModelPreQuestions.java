...
public class QuestionModelPreQuestions {
    ...
    private ArrayList<QuestionModelPreOption> Options;
    ...
    public ArrayList<QuestionModelPreOption> getOptions ()
    {
        return Options;
    }

    public void setOptions (ArrayList<QuestionModelPreOption> Options)
    {
