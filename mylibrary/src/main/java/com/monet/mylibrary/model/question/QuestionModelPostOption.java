...
public class QuestionModelPostOption {
    ...
    private ArrayList<QuestionModelPostGrid> grid;
    ...
    public ArrayList<QuestionModelPostGrid> getGrid ()
    {
        return grid;
    }

    public void setGrid (ArrayList<QuestionModelPostGrid> grid)
    {
        this.grid = grid;
    }
